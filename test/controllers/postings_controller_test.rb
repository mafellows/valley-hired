...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { city: @posting.city, company: @posting.company, description: @posting.description, link: @posting.link, position: @posting.position }
    end
  ...
  test "should update posting" do
    patch :update, id: @posting, posting: { city: @posting.city, company: @posting.company, description: @posting.description, link: @posting.link, position: @posting.position }
    assert_redirected_to posting_path(assigns(:posting))
  end
